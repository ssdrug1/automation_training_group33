...
class LogInNewGroupCreationLogOut(unittest.TestCase):
    ...
    def test_add_new_group(self):
        ...
        self.new_group_creation(wd, Group(name="new_group", header="new_group", footer="new_group"))
    ...
    def test_add_new_empty_group(self):
        ...
        self.login(wd, user="admin", password="secret")
        self.open_group_page(wd)
        self.new_group_creation(wd, Group(name="", header="", footer=""))
        self.return_to_group_page(wd)
        self.logout(wd)
    ...
    def new_group_creation(self, wd, group):
        #  init new group
